...
**Что этим НЕ закрыто.** Реализовано правило и его источник. Drill — то есть подтверждённая доставка page-алерта до дежурного с измеренным time-to-alert — остаётся открытым пунктом `#19`.
