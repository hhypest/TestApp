...
Всего 324 теста: 26 Core, 137 Domain, 45 Application, 116 Integration. Проценты в таблице замерены на 267 тестах (`0.9.5`); presentation/resume добавил 15 интеграционных тестов, `STAB-009` — 31 domain и 1 integration сверх этого замера.
